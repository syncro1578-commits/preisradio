  ...
  return (
    <section className="relative">
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link
          href={viewAllLink}
          className="hidden sm:inline-flex items-center text-sm md:text-base text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 font-medium whitespace-nowrap"
        >
          Alle ansehen
          <svg
